...
import { useEditRegularJob } from "@/hooks/useEditRegularJob";
            ...
            <div className="grid grid-cols-2 w-full gap-10 mt-4  ">
              ...
              <div className="flex mb-28 mt-6 justify-center col-span-2 ">
                {load ? (
                  <button
                    type="button"
                    className="bg-green-300 cursor-not-allowed  w-40 h-11 text-[#fcfefd] rounded-[10px] font-bold  mt-15 whitespace-nowrap   max-lg:mt-0  max-sm:mt-20 text-base max-sm:text-sm"
                  >
                    {" "}
