...
const DashboardNavbar = () => {
  ...
  return (
    <>
      ...
      <header
        className="px-10  lg:py-8 fixed w-full bg-white backdrop-blur z-20 max-xl:shadow"
        ref={dropdownRef}
      >
        <div className="flex-c-b w-full max-lg:py-4">
          ...
          <div className="flex-c sm:gap-5 gap-4">
            ...
            <div className="flex-c sm:gap-6 gap-4">
              <div className="flex-c sm:gap-6 gap-4 text-gray-900 max-xl:hidden">
                <div>
                  <Link
                    href="/dashboard/job/direct-contract"
                    className="font-medium px-5 sm:py-2 py-1 rounded-md hover:bg-green-600 max-sm:text-sm bg-primary-green text-white transition-all duration-300"
                  >
                    Direct Contract
                  </Link>
                </div>
                <div>
                  <Link
                    ...
                    className="font-medium px-5 sm:py-2 py-1 rounded-md  hover:bg-[#063038] max-sm:text-sm bg-[#054753] text-white transition-all duration-300 "
                  >
                    Planned Maintenance
                  </Link>
                </div>
