        ...
        {loading ? (
          ...
          <div className="grid grid-cols-12 py-10 gap-6">
            ...
            <div className="col-span-9 max-lg:col-span-12 flelx flex-col w-full bg-white rounded-lg py-10 ">
              <ul className="flex-c flex-wrap gap-4   px-10 max-sm:px-5">
              ...
              <div className="w-full px-10 max-sm:px-5 py-6">
                ...
                <p className=" max-sm:text-xs">
                  {currentMilestone?.milestoneDescription &&
                    currentMilestone?.milestoneDescription}
                  <button className="text-[#25C269]  text-sm font-medium leading-[16px] max-sm:text-xs whitespace-nowrap">
                    see more
                  </button>
                </p>
              </div>
                ...
                <div className="flex  gap-10 max-sm:gap-5  py-6">
                  <div className=" flex gap-2">
                    ...
                    <div className="flex flex-col  gap-1">
                      <h6 className=" text-[18px] font-semibold max-sm:text-sm">
              ...
              {currentMilestone.milestoneStatus === "ongoing" ? (
                <div className="flex flex-col  px-10 max-sm:px-5 w-full py-6">
                  ...
                  <div className="py-8">
                    <button className="bg-[#A2A4A2] round-lg w-[148px] h-[52px] text-[#FCFEFD] font-bold max-sm:w-[120px] max-sm:h-[38px] max-sm:text-sm ">
                      Payment
                    </button>
                  </div>
                </div>
                ...
                <div className="flex flex-col  px-10 max-sm:px-5 w-full py-6">
                  ...
                  <>
                    {currentMilestone.invoice.paymentStatus === "paid" ? (
                      ...
                      <div className="py-8">
                        <button
                          className="bg-primary-green round-lg w-[148px] h-[52px] text-[#FCFEFD] font-bold max-sm:w-[120px] max-sm:h-[38px] max-sm:text-sm"
...
export default ActiveRegularJobInfo;
