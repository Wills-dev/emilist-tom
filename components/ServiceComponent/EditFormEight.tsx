...
interface EditFormEightProps {
  coverageArea: string[];
  setCoverageArea: any;
  prevPage: () => void;
  handleEditBusiness: (serviceId: string) => Promise<void>;
...
const EditFormEight = ({
  ...
  const handleStateClick = (state: string) => {
    if (coverageArea.includes(state)) {
      ...
      setCoverageArea([...coverageArea, state]);
    }
  };
      ...
      import("leaflet").then((L) => {
        ...
        const handleMapClick = async (e: {
          ...
          try {
            ...
            setCoverageArea((prev: any) => [...prev, placeName]);
          } catch (error) {
        ...
        <div className="pt-28 max-md:pt-24 max-md:pb-15 px-10 w-full max-md:px-5 max-sm:px-3">
          <div className="w-full mt-10 max-md:mt-5">
            ...
            <div className="col-span-4 border-t-1 border-[#B8B9B8] w-full pt-4">
              ...
              <div className="flex justify-end mb-28 mt-6 gap-5 col-span-4">
                ...
                {isSubmitting ? (
                  ...
                  <button
                    onClick={() => handleEditBusiness(serviceId)}
